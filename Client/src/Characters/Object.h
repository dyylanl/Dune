...
#ifndef DUNE_OBJECT_H
#define DUNE_OBJECT_H
...
public:
    Object() : m_player(0), m_life(0), m_action(false) {}

    Object(std::string &type, int &player, SDL2pp::Point &position, SDL2pp::Point &posAction, int &life, bool &action)
    ...
    Object(std::string objectType, int player, bool selectStatus, int posX, int posY, int posActX, int posActY,

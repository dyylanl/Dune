...
ButtonBuild::ButtonBuild(char textureID, SDL2pp::Point position, int id, char player, int constructionTime, bool selectStatus, bool ready)
...
void ButtonBuild::update(EventManager &eventManager, BlockingQueue<CommandCL *> &queue) {
...
void ButtonBuild::draw(SDL2pp::Renderer &renderer, TextureManager &textureManager) {

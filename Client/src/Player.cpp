...
Player::Player(std::string textureID, TextureManager &manager) : m_Animation(manager, textureID, SDL_FLIP_NONE), facingLeft(false), moving(false), x(300), y(300), m_TextureID(textureID){}

...
GameConfiguration::GameConfiguration(const ConfigurationReader& config) :
        ...
        spiceRefineryEnergy(config.getEnergyFor(Building::BuildingType::REFINERY)),
        spiceRefineryCost(config.getCostFor(Building::BuildingType::REFINERY)),
        spiceRefineryHitPoints(config.getHitPointsFor(Building::BuildingType::REFINERY)),
        spiceRefinerySpiceCapacity(config.getSpiceCapacityFor(Building::BuildingType::REFINERY)),
        spiceRefineryWidth(config.getWidthFor(Building::BuildingType::REFINERY)),
        spiceRefineryHeight(config.getHeightFor(Building::BuildingType::REFINERY)),

        spiceSiloEnergy(config.getEnergyFor(Building::BuildingType::SILO)),
        spiceSiloCost(config.getCostFor(Building::BuildingType::SILO)),
        spiceSiloHitPoints(config.getHitPointsFor(Building::BuildingType::SILO)),
        spiceSiloSpiceCapacity(config.getSpiceCapacityFor(Building::BuildingType::SILO)),
        spiceSiloWidth(config.getWidthFor(Building::BuildingType::SILO)),
        spiceSiloHeight(config.getHeightFor(Building::BuildingType::SILO)),
